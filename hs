...
;base_url = "http://localhost/jurnal"
base_url = "https://jurnal.unmer.ac.id"
...
; Syntax: base_url[journal_path] = http://jurnal.unmer.ac.id/myjournal/files
...
;unmer jurnal:
;base_url[index] = http://jurnal.unmer.ac.id
base_url[index] = https://jurnal.unmer.ac.id/index.php/index
base_url[myJournal] = https://jurnal.unmer.ac.id/myjournal
...
; files_dir = /myjournal/files
files_dir = /var/www/jurnal.unmer.ac.id/myjournal/files

; Path to the directory to store public uploaded files
; (This directory should be web-accessible and the specified path
; should be relative to the base OJS directory)
; Windows users should use forward slashes
; public_files_dir = /puskom32/www/htdocs/jurnal/public
...
smtp_port = 465
;smtp_server ="tls/starttls://smtp.gmail.com"
;smtp_port = 587
...
smtp_username = "jurnal@unmer.ac.id"
smtp_password = "ojsUnmerMerdeka"
...
default_envelope_sender = jurnal@unmer.ac.id
...
repository_id = jurnal.unmer.ac.id
...
font_location = /var/www/jurnal.unmer.ac.id/public_html/FreeSerif.ttf

;recaptcha = on 
;recaptcha_public_key = 6Lf_Ld8ZAAAAAFTT3HVdxdmTp8Gz-nGXytIKqdtg 
;recaptcha_private_key = 6Lf_Ld8ZAAAAAGD5Zkdgi4B0dum8PTOvyyg1v9fp Kolom registrasi
